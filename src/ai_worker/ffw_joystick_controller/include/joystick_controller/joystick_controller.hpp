...
protected:
  ...
  void base_motion_lock_callback(const std_msgs::msg::Bool::SharedPtr msg);
  ...
  std::map<std::string, std::vector<double>> sensor_min_positions_;
  std::map<std::string, std::vector<double>> sensor_max_positions_;
  std::map<std::string, bool> sensor_was_joint_jog_active_;
  std::map<std::string,
  ...
  rclcpp::Subscription<std_msgs::msg::Bool>::SharedPtr base_motion_lock_subscriber_;
  ...
  std::atomic_bool base_motion_locked_{false};
  std::atomic_bool base_unlock_requires_center_{false};
};
