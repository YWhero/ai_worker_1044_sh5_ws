...
def generate_launch_description():
    declared_arguments = [
        ...
        DeclareLaunchArgument(
            'world',
            default_value='l_sorting_workcell',
    ...
    # The isolated workcell assets are installed in the existing nested model
    # resource tree, so expose that model directory to Gazebo Sim.
    ...
    gazebo = IncludeLaunchDescription(
                ...
                launch_arguments=[
                    ('gz_args', [
                        ...
                        '.sdf',
                        ' -v 1',
                        # Keep the same DART-based SG2 contact behavior as the
                        # existing data-collection simulation.
    ...
    initial_camera_pose = ExecuteProcess(
        cmd=[
            ...
            (
                ...
                '--timeout 5000 --req '
                "'name: \"user_camera\", pose: {position: {x: 5.8, "
                'y: -4.8, z: 5.2}, orientation: '
                '{x: -0.2277973434, y: 0.0965250714, z: 0.8921266914, '
                "w: 0.3780228133}}'; "
                'exit $?; '
                'fi; '
                'sleep 1; '
