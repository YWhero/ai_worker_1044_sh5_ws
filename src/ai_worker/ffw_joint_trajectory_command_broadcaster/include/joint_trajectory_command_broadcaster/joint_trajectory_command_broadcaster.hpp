...
protected:
  ...
  std::unordered_map<std::string, std::vector<double>> group_min_positions_;
  std::unordered_map<std::string, std::vector<double>> group_max_positions_;
