...
class MessageRepository:
    ...
    msg_path: str
    packages: List[str]
    flat_layout: bool = False  # True for single-package repos with msg/ at root.
...
MESSAGE_REPOSITORIES: Dict[str, MessageRepository] = {
    ...
    # Official ROBOTIS hand tactile interfaces. This is a single-package
    # repository with msg/ at its root, unlike most ROS meta-package repos.
    "robotis_interfaces": MessageRepository(
        url="https://github.com/ROBOTIS-GIT/robotis_interfaces.git",
        commit="9231cb1005dc03c14bdbf42f1f9b7114af7d3cfb",
        cache_path="robotis_interfaces",
        msg_path="",
        packages=["robotis_interfaces"],
        flat_layout=True,
    ),
