...
def _recording_source_metadata() -> dict:
    schema_version = os.environ.get('CYCLO_EPISODE_SCHEMA_VERSION', '').strip()
    if not schema_version:
        return {}
    metadata = {'schema_version': schema_version}
    tactile_source = os.environ.get('CYCLO_SIM_TACTILE_SOURCE', '').strip()
    if tactile_source:
        metadata['simulation'] = {
