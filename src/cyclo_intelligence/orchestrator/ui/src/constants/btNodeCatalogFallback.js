...
export const FALLBACK_CATALOG = [
  ...
  },
  {
    ...
    ports: [
      ...
      { name: 'angular_velocity', type: 'number', default: '0.6' },
      { name: 'tolerance_deg', type: 'number', default: '0.1' },
      { name: 'timeout_sec', type: 'number', default: '60.0' },
    ],
  },
  {
    tag: 'JointControl',
  ...
  },
  {
    ...
    ports: [
      ...
      { name: 'initial_pose_sync', type: 'bool', default: 'false' },
      { name: 'initial_pose_sync_duration_s', type: 'number', default: '5.0' },
