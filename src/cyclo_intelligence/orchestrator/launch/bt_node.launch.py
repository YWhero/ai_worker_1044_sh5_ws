...
def launch_setup(context, *args, **kwargs):
    ...
    state_groups = robot_schema.get_bt_state_groups(section)
    action_groups = robot_schema.get_bt_action_groups(section)
    ...
    joint_topic_list = [
        ...
        f'follower_tactile_{name}:{cfg["topic"]}'
        for name, cfg in tactile_topics.items()
    ]
    joint_topic_type_list = [
        ...
        f'follower_tactile_{name}:{cfg["msg_type"]}'
        for name, cfg in tactile_topics.items()
    ]
